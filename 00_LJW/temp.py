...
_base_ = [
    'E:/LJW/Git/my_mmpose/mmpose/configs/_base_/default_runtime.py',
    'E:/LJW/Git/my_mmpose/mmpose/configs/_base_/datasets/tower_12456.py'
]
...
data_root = f'E:/LJW/mmpose/00_LJW/resized_dataset/{img_size}'
data = dict(
