...
class TowerTopDown(BasePose):
    ...
    def forward(self,
        ...
        return self.forward_test(
            img, img_metas, target_weight, return_heatmap=return_heatmap, **kwargs)
    ...
    def forward_train(self, img, target, target_weight, img_metas, **kwargs):
        ...
        if self.with_keypoint:
            # output = self.keypoint_head(output, target_weight)
    ...
    def forward_test(self, img, img_metas, target_weight, return_heatmap=False, **kwargs):
        ...
        if self.with_keypoint:
            ...
            # output_heatmap = self.keypoint_head.inference_model(
            #     features, flip_pairs=None, target_weight=target_weight)
